...
export const signUp = async (req, res) => {
    const { email, password, name, verified, phone, gender, dateOfBirth, avatar, status } = req.body;
    try {
        ...
        if (!user) {
            ...
            const token = jwt.sign({ id: newUser._id }, process.env.JWT_SECRET, { expiresIn: '100y' });
